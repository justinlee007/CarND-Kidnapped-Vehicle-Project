 ...
 * @output True if opening and reading file was successful
 */
inline bool read_control_data(string filename, vector<control_s> &position_meas) {
 ...
 * @output True if opening and reading file was successful
 */
inline bool read_gt_data(string filename, vector<ground_truth> &gt) {
 ...
 * @output True if opening and reading file was successful
 */
inline bool read_landmark_data(string filename, vector<LandmarkObs> &observations) {
